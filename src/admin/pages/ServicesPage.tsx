...
const ServicesPage = () => {
  ...
  return (
    <AdminLayout title="Services">
      ...
      <FormModal open={modalOpen} onOpenChange={setModalOpen} title={editing && items.some((i) => i.id === editing.id) ? "Edit Service" : "Tambah Service"} fields={fields} value={editing} onChange={(v) => setEditing(v)} onSubmit={save} />
